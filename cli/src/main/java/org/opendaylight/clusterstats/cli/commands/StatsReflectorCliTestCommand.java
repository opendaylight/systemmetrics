 ...
 */
package org.opendaylight.clusterstats.cli.commands;
...
public class StatsReflectorCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(StatsReflectorCliTestCommand.class);
    protected final StatsReflectorCliCommands service;

    public StatsReflectorCliTestCommand(final StatsReflectorCliCommands service) {
